...
namespace monopUtil{
    ...
    bool compareRolls(const std::shared_ptr<Player>& p1,const std::shared_ptr<Player>& p2); // Compares the dice rolls of two players and returns true if p1 has a higher roll than p2 
}